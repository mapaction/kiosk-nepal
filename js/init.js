...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			'normal': { range: '-1280', href: 'css/style-normal.css', containers: '100%', grid: { gutters: 40 } },
			'narrow': { range: '-700', href: 'css/style-narrow.css', containers: '100%' },
			'narrower': { range: '-350', href: 'css/style-narrower.css', lockViewport: true, grid: { gutters: 30, collapse: 1 } },
